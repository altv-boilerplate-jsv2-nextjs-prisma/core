...
const ESBUILD_CONFIG = {
    ...
    format: 'esm',
    platform: 'node', // Specify that we are bundling for Node.js
    external: ['@altv/client', '@altv/shared', '@altv/natives', '@assets'],
};

const excludedPaths = ['client/html']; // an array of excluded filepaths
const corePath = 'resources/core';
...
const serverFiles = glob.sync('./src/core/server/**/*.ts');
const sharedFiles = glob.sync('./src/core/shared/**/*.ts');
